                ...
                <div class="container">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="txtLname" placeholder="Last Name" runat="server">
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="email">Email</label>
                        <label for="email" style="color: red;">*</label>
                        <input type="email" class="form-control" id="txtEmail" placeholder="sample@email.com" runat="server">
                    </div>
                    <div class="form-group">
                        <label for="comments">Message</label>
                        <textarea rows="5" class="form-control" id="txtMessage" placeholder="Leave a message (Optional)" runat="server"></textarea>
                    </div>
