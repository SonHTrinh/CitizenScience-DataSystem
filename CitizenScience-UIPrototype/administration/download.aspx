    ...
    <script>
        $(document).ready(function () {
            ...
            $('#downloadCSV').click(function () {
                ...
                if (isDownloadAll) {
                    window.location.href = 'https://np-stem.temple.edu/CIS4396-F06/api.asmx/AllLocationTemperaturesCsv';
                } else {
                    var idParameters = '?';
                    ...
                    window.location.href = 'https://np-stem.temple.edu/CIS4396-F06/api.asmx/LocationTemperaturesCsv' + idParameters;
                }
